...
theme <-bs_theme_update(theme, bg = "#D9FFE5", fg = "#000000", 
...
### World map
Here is a map of world deforestion over time. 
```{r echo=FALSE, message=FALSE, warning=FALSE}
...
### Replace with leaflet map about world forest cover
})
...
Overall it is expected that soy production will increase by % by the year 2030 and % by 2040. This could have a devastating impact on deforestation in Brazil and Argentina and other contries around the world. 
```{r echo=FALSE, message=FALSE, warning=FALSE}
ui =  fluidPage(
          theme = theme,
          sidebarLayout(
...
Soy is an excellent source of protien, maybe we could just eat it ourselves? 
```{r}
## sankey diagram energy flow or protein or something. 
```
