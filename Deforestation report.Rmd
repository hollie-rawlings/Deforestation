...
soybean_farming_map_data <- reactive({soybean_farming_data %>%
                                                        filter(!is.na(code))%>%
                                                        filter(year==input$years_slide)
})
  
output$world_map <-renderPlotly({
data <- soybean_farming_map_data()
  
plot_ly(data, type='choropleth', locations=data$code, z=data$human_food, text=data$entity, colorscale="Blues")
})
