...
theme <-bs_theme_update(theme, bg = "#FFFFFF", fg = "#029232", 
    base_font = "Arial", heading_font = "Arial", 
    font_scale = 1.33, `enable-gradients` = TRUE, spacer = "2rem")
```
Introduction
===================================== 
...
Column{.tabset .tabset-fade data-width=800 data_height=700}
-----------------------------------------------------------------------
...
Conclusion remarks {data-orientation=rows}
===================================== 
