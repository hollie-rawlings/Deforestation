...
2. Next I look for a primary key iD to join the two on, in this case its the 3 letter code, I do an inner join so that all the things I dont want in soybean_farming are not included. Then Ill select what we need. 
